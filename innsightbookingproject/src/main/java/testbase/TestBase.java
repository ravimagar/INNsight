...
public class TestBase {
    ...
    public void initialization() {
        ...
        if (browserName.equals("chrome")) {
            System.setProperty("webdriver.chrome.driver", "/Users/Ravindra Magar/Downloads/chromedriver_win32/chromedriver.exe");
            driver.set(new ChromeDriver());
        } else if (browserName.equals("firefox")) {
            System.setProperty("webdriver.gecko.driver", "/Users/Ravindra Magar/Downloads/edgedriver_win64/msedgedriver.exe");
            driver.set(new FirefoxDriver());
        } else if (browserName.equals("edge")) {
            System.setProperty("webdriver.edge.driver", "/Users/Ravindra Magar/Downloads/geckodriver-v0.31.0-win64/geckodriver.exe");
